    ...
    <div className="rounded-xl shadow-md relative">
      ...
      <div className="p-4">
        <div className="text-left md:text-center lg:text-left mb-6">
          ...
          <h3 className="text-xl font-bold">{property.name}t</h3>
        </div>
        ...
        <div className="flex justify-center gap-4 text-gray-500 mb-4">
          <p>
            <FaBed className="fa-solid fa-bed md:hidden lg:inline"></FaBed>{" "}
            {property.beds} <span className="md:hidden lg:inline">Beds</span>
          </p>
          <p>
            <FaBath className="fa-solid fa-bath md:hidden lg:inline"></FaBath>{" "}
